...
function Formation({language}) {
    ...
    <div className='formation__container'>
      ...
      <img style={{marginTop:25}} src="./istqb.png" className="istqb logo" alt="logo" width={150} />
    ...
    <img style={{marginTop:35}} src={opquast} className="opquast logo" alt="logo" width={150}  />
    <div className='texte-formation__container'>
      ...
      <img style={{marginTop:35}} src="https://www.z-association.fr/wp-content/uploads/2024/02/logo_Z-code-pour-emploi.svg" className="programmeZ logo" alt="logo" width={150}  />
